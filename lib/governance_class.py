...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to madcoind "gobject list" output
    ...
    def madcoind_serialise(self):
        import madcoinlib
        return madcoinlib.SHIM_serialise_for_madcoind(self.serialise())
